    ...
    <div id="beehive-page" class="site">
        <div id="beehive-page" class="site">
                ...
                <nav class="navbar beehive-navbar social fixed-top">
                    <div class="container">
                        ...
                        <ul id="navbar-user" class="navbar-nav navbar-user">
                            ...
                            <li class="nav-item">
                                <a href="{{route('logout')}}" class="nav-link login" data-toggle="modal"
			...
			<div class="elementor-custom-embed">
                <iframe frameborder="0" scrolling="no"style="width: 150%; height: 200px;" marginheight="0" marginwidth="0" 
                src="https://maps.google.com/maps?q=3rd%20ring%20moscow&amp;t=m&amp;z=13&amp;output=embed&amp;iwloc=near" title="3rd ring moscow" aria-label="3rd ring moscow">
                                                                ...
                                                                <li class="item-entry animate-item slideInUp odd public group-has-avatar"
                                                                    ...
                                                                    <div class="list-wrap">
                                                                        ...
                                                                        <div class="item-cover" 
                                                                            style="background-image: url('{{asset('wp-admin/images/'.$gymrooms->backgound_image)}}')">
                                                                        </div>

                                                                        <div class="item-avatar">
                                                                            <a
                                                                                href="https://mythemestore.com/beehive-preview/groups/backpakers-club/"><img
                                                                                    loading="lazy"
                                                                        ...
                                                                        <div class="item">
                                                                            ...
                                                                            <div class="item-block">
                                                                                ...
                                                                                <h5 class="list-title groups-title"><a
                                                                                        ...
                                                                                        class="bp-group-home-link backpakers-club-home-link"></a>
                                                                                </h5>
