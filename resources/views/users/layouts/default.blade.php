...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="{{ asset('forntend/assets/img/favicon.png')}}">
	...
	<link rel="stylesheet" href="{{ asset('forntend/assets/releases/v5.8.2/css/all.css')}}"> </head>
