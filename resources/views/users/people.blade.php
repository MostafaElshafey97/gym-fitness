                                                ...
                                                <div id="buddypress"
                                                    ...
                                                    <nav class="members-type-navs main-navs bp-navs dir-navs "
                                                        ...
                                                        <ul class="component-navigation members-nav">
                                                            ...
                                                            <li id="members-all" class="" data-bp-scope="all"
                                                                ...
                                                                <a href="/members-2/">
                                                                    All Members
                                                                    <span class="count">{{$peoplesall}}</span>
                                                                </a>
                                                            </li>
                                                            <li id="members-all" class="" data-bp-scope="all"
                                                                data-bp-object="members">
                                                    ...
                                                    <div class="screen-content">
                                                        ...
                                                        <div id="members-dir-list" class="members dir-list"
                                                            ...
                                                            <div id="members-dir-list" class="members dir-list"
                                                                data-bp-list="members" style="display: block;">
                                                                ...
                                                                <ul id="members-list"
                                                                    ...
                                                                    <li class="item-entry animate-item slideInUp odd"
                                                                        data-bp-item-id="3"
                                                                        ...
                                                                        <div class="list-wrap">
                                                                            ...
                                                                            <div class="item-avatar">
                                                                                <a
                                                                                    href="#"><img
                                                                                        loading="lazy"
                                                                                        src="{{ asset('wp-admin/images/'.$people->image) }}"
                                                                            ...
                                                                            <div class="item">
                                                                                ...
                                                                                <div class="item-block">
                                                                                    ...
                                                                                    <p class="latest-update">WASSSSSU
                                                                                        PEEPS</p>

                                                                                    <ul class=" members-meta action">
                                                                                        <li class="generic-button"><a
                                                                                                href="https://mythemestore.com/beehive-preview/members/user/">View
                                                                                                Profile</a></li>
                                                                                    </ul>
                                                                                </div>
